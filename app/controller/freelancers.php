...
namespace Controller;
	...
	class Freelancers extends \Core\Controller {
		...
		public function index() {
			...
			if(isset($_GET['price_start']) && isset($_GET['price_end']))
				$serviceUser = \Model\Service::where('tagid', $serviceItem->id)->where('price', '>', $_GET['price_start'])->where('price', '<', $_GET['price_end'])->where('deleted', null)->get();
			else
				$serviceUser = \Model\Service::where('tagid', $serviceItem->id)->where('deleted', null)->get();
